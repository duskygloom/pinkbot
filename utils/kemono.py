...
logger = get_logger("utils.kemono")

homepage = "https://kemono.su"
api_endpoint = "https://kemono.party/api/v1"
...
class Creator:
    ...
    @property
    def icon(self):
        return f"https://img.kemono.su/icons/{self.service}/{self.id}"
...
class PaginationView(discord.ui.View):
    ...
    async def prev_callback(
        ...
        await interaction.message.edit(
            content=f"{self.index+1}/{len(self.items)}",
...
async def get_posts(query: str, page: int) -> list[Post]:
